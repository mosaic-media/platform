...
--
-- The perishable half of platform#28's durable/perishable split. Candidates are
...
-- library is install-global (platform#9) and a resolved URL is a property of the
...
CREATE TABLE IF NOT EXISTS playback_resolutions (
    ...
    -- A stable digest of the client profile declared on Attach (web#4).
    ...
    -- correctness input — platform#28 rejects a TTL as the mechanism precisely
...
-- is the opposite of the content model's stance (platform#9), and deliberately so.

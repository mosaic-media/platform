...
// Capabilities do not implement their own concurrency control; the database
// provides it, and uniqueness/serialization conflicts surface as SQLSTATE
// codes that mapError translates to Platform categories.
func Connect(ctx context.Context, dsn string) (*pgxpool.Pool, error) {
	...
	// A span per statement (platform#33, seam 6). Set on the pool config so every

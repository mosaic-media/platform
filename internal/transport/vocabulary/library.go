...
// published contract carried a second set of the same names, and the two
// drifted (three of the four that existed in both had). There is one library
// now and it is the contract's; this reads it rather than keeping a copy.

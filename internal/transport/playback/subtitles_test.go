...
// The delivery half of platform#83, which is where the escalation stops being a
// computed value and becomes something on a screen (platform#83).
...
// TestAdamsTwoReleasesEndUpWithDifferentTracks is the pair of cases platform#83 was
...
// TestALanguageNobodyAskedForIsNeverTurnedOn is platform#83's rule stated as a
...
// TestSubtitlesOffNeverBurns is the strongest form of platform#83's rule. Burning
...
// The third answer: send the script and let the client draw it (platform#83).
...
// owes. Somebody who chose "as authored" under platform#83 chose the burn, because

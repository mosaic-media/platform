...
// TestSegmentArgsCarryThePositionAndTheNumbering is the mechanism ADR 0111 turns
...
// TestOnlyAnEncodeForcesKeyframes is the asymmetry ADR 0111 rests on. Where the

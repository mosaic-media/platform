...
// affordance is Add to library (platform#18 — materialising is the deliberate act,
...
func (s *Service) contentCard(ref v1.ContentRef, title string, year int, poster string, inLibrary bool) *ui.Element {
	...
	// Both planes open the same ref-based rich detail (sdk#3); PreviewContent
